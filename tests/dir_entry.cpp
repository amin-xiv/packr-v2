...
TEST_F(dirAndFileEntryConstructorData, DirectoryEntryConstructorData) {
    ...
    EXPECT_EQ(dirEntry.m_child_entry_count, 4);
    EXPECT_EQ(dirEntry.m_child_file_count, 3);
    EXPECT_EQ(dirEntry.m_child_dir_count, 1);
    EXPECT_EQ(dirEntry.m_total_entry_count, 9);
    EXPECT_EQ(dirEntry.m_total_file_count, 6);
